#
# Module manifest for module 'PowerShellToolkitForHPEPrimeraAnd3PAR'
#
# Generated by: Hewlett Packard Enterprise Development LP
#
# Generated on: 04-06-2020
#
...
Description = 'The PowerShell Toolkit for HPE Primera and HPE 3PAR provides storage administrators the convenience of managing HPE Primera and HPE 3PAR Storage Systems from a Microsoft Windows PowerShell environment.'
...
NestedModules = @('.\CLI\HPE3PARPSToolkit-CLI.psm1', 
               '.\WSAPI\HPE3PARPSToolkit-WSAPI.psm1', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'HPE Primera PS Cmdlets', 'HPE 3PAR PS Cmdlets', 'HPE Primera CLI', 
               'HPE 3PAR CLI', 'HPE Primera WSAPI', 'HPE 3PAR WSAPI', '3PAR PSTK', 
               'PRIMERA PSTK'
